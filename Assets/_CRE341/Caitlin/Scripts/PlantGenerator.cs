...

{
    ...
    public GameObject PlantPrefab, waypointsPrefab; // Reference to your cage prefab
    public GameObject groundObject;
    public int width;
    public int height;

    [SerializeField] int numberOfPlants = 5;
    ...
    private void SpawnItems(int count)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            {
                Instantiate(PlantPrefab, randomItems, Quaternion.identity);
                // add the NPC to the list
                plants.Add(PlantPrefab);
            }
            else
            {
