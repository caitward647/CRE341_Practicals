...
public class FlockingAgent2 : MonoBehaviour
{
    [Header("Leader Separation")]
    public float leaderSeparationWeight = 3f; // Weight for separation from the leader
    public float leaderSeparationRadius = 5f; // Radius within which to separate from the leader

    [Header("Movement")]
    public float baseSpeed = 7f; // Base speed of the agent
    public float speedVariation = 2f; // Maximum variation from the base speed
    ...
    public float maxSpeed = 7f; // Maximum speed for flocking
